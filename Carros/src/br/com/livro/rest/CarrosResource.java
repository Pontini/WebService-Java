...
@Path("/carros") //Configura o path
@Produces(MediaType.APPLICATION_JSON+";charset=utf-8") //define o tipo de conteúdo que o método retorna
@Consumes(MediaType.APPLICATION_JSON+";charset=utf-8")//Define o conteúdo que o método  consome
